interface configuration {
    ...
    language: string,
    /**
     * Path for actions json file
     */
    actionJsonPath: string,
    /**
     * Path for translation json file
     */
    ...
    /**
     * Whether or not to display user image. 
     * Note: user image must be uploaded to assets/img/ folder with surname.name.extension naming convenction
     */
    displayUserImage: boolean,
    /**
     * Determines if username is displayed in navigation bar
     */
    displayUsername: boolean,
    /**
     * Determines whether user titles will be display in navigation bar
     */
    displayUserTitle: boolean,
    /**

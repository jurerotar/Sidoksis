...
import Data, {State} from "./modules/data.class.js";
...
async function initialize() {
    const construct:Construct = new Construct(document.getElementById('mainContainer'));
    const data:Data = new Data();
    const popup:Popup = new Popup();
    const loader:Loader = new Loader(<HTMLDivElement>document.querySelector('.loader'));
    ...
    if(bodyFinished) {
        ...
        const navigation:NavigationBar = new NavigationBar(document.querySelector('.navigation'));
